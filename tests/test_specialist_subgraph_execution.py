...
async def test_a_public_hard_limit_propagates_without_authoring_assistant_text():
    """The parent wrapper owns conversion of a framework limit to a typed error."""
