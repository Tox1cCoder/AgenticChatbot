...
> - Final verification (2026-06-11): acceptance focused suites (subagents + both adapter contracts + activity live + graph planning/streaming/handoff + message-service subagent + demo activity/rendering) **81 passed**; full suite **1072 passed** (same single exclusion as Task 10: `tests/client_backend/test_live_server_integration.py`, needs a live server on :8000).
