...
def estimate_tokens(text: str) -> int:
    ...
    Uses tiktoken if available for accurate counting, otherwise falls back
    to a simple heuristic of characters / 4.
...
def split_into_sentences(text: str) -> List[str]:
    ...
    Uses NLTK if available for better sentence detection, otherwise uses
    ...
    try:
        ...
        logger.debug(f"Error using NLTK, falling back to regex: {e}")
    
    # Split on periods, exclamation marks, or question marks followed by whitespace
...
def create_smart_chunks(
    ...
    """
    Create smart text chunks with optional sentence-aware splitting.
