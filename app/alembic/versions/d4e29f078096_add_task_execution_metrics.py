...
def upgrade() -> None:
    ...
    op.add_column(
        "task_plans", sa.Column("started_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "task_plans",
    ...
    op.add_column(
        "task_plans", sa.Column("actual_duration_minutes", sa.Integer(), nullable=True)
    )
    op.add_column(
        "task_plans",
    ...
    op.add_column(
        "task_plans", sa.Column("completion_confidence", sa.Float(), nullable=True)
    )
