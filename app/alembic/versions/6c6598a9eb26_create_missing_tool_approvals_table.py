...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "original_args", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "modified_args", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "decision",
    ...
    op.create_index(
        op.f("ix_tool_approvals_id"), "tool_approvals", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_tool_approvals_user_id"), "tool_approvals", ["user_id"], unique=False
    )
    ...
    op.drop_index(
        op.f("ix_mcp_oauth_tokens_server_name"), table_name="mcp_oauth_tokens"
    )
    ...
    op.create_index(
        op.f("ix_agent_model_configs_id"), "agent_model_configs", ["id"], unique=False
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_hitl_interrupts_status_expires_at"), table_name="hitl_interrupts"
    )
    op.create_index(
    ...
    op.create_foreign_key(
        None, "hitl_interrupts", "messages", ["assistant_message_id"], ["id"]
    )
    op.drop_column("messages", "extra_metadata")
    op.drop_column("messages", "citations")
    op.create_index(
        op.f("ix_model_providers_id"), "model_providers", ["id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.add_column(
        "task_plans",
        sa.Column(
            "actual_duration_minutes", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "task_plans",
    ...
    op.create_index(
        op.f("ix_task_plans_status"), "task_plans", ["status"], unique=False
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_hitl_interrupts_assistant_message_id"), table_name="hitl_interrupts"
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_agent_model_configs_user_id"), table_name="agent_model_configs"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "server_name", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_mcp_oauth_tokens_state"), "mcp_oauth_tokens", ["state"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_mcp_oauth_tokens_id"), "mcp_oauth_tokens", ["id"], unique=False
    )
    op.create_table(
        "checkpoint_blobs",
    ...
    op.drop_index(
        op.f("ix_tool_approvals_conversation_id"), table_name="tool_approvals"
    )
