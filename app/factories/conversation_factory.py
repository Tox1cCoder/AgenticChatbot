...
class ConversationFactory:
    ...
    def create_from_schema(
        ...
        """Create Conversation entity from ConversationCreate schema"""
        return Conversation(
            id=uuid4(),
            user_id=owner_id,
    ...
    @staticmethod
    def create_from_dict(conversation_data: Dict[str, Any]) -> Conversation:
        """Create Conversation entity from dictionary"""
